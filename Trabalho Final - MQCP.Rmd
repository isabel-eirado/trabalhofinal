...
-  A fim de analisar a variação das datas de promulgação das constituições estaduais vigentes, construímos um gráfico de densidade. Optou-se por esse tipo de gráfico por que:
...
```
- Após identificar o pico de promulgação das constituições vigentes, segue-se para analisar a variação do número de palavras das constituições vigentes em cada Estado, a fim de identificar correlações.
