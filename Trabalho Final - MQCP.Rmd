...
```{r paged.print=TRUE, echo=FALSE, fig.height=6, fig.width=8}
...
```{r echo=FALSE, fig.height=5, fig.width=9, paged.print=TRUE}
...
```{r fig.height=5, fig.width=9, paged.print=TRUE, echo=FALSE}
constituicoes_poderes %>%
