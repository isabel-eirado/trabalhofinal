...
1. O Alabama é um outlier na medida em que dispõe de um total de palavras absurdamente maior do que qualquer outro estado
...
O gráfico informa que houve variação considerável do número de palavras da Constituição vigente nos estados com relação à média, esta considerando todas as consituições. Portanto, há indícios de que o tempo e o número de palavras contribuem com mudanças constitucionais.
