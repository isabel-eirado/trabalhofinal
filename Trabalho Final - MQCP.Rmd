...
A fim de identificar a diferença do número de palavras das constituições vigentes em cada Estado, criamos um gráfico de pontos (scatter chart). A partir das variáveis em foco (total_words e state) é possível evidenciar a distribuição de palavras nas constituições dos Estados.
